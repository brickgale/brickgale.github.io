  ...
  <div class="relative">
    ...
    <div class="flex flex-col max-w-[800px] m-auto p-4 justify-center items-center">
      <Card class="max-w-[300px] w-full mb-4 p-4 relative justify-center items-center -mt-15 z-10">
        <div class="w-[80px] h-[80ppx] relative -mt-15 mb-6 cursor-pointer z-20">
...
const linkClasses = 'p-2.5 text-sm border-[var(--foreground-subtle)]/30 hover:text-[var(--secondary-color)] transition-colors duration-300';
